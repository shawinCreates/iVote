...
export default function SignupPage(): JSX.Element {
  ...
  const validateForm = () => {
    ...
    if (!tuNumber) newErrors.tuNumber = "TU registration number is required.";
  ...
  const handleFileChange = (file: File | null) => {
    ...
    try {
      ...
      formData.append("tu_registration_number", tuNumber);
      formData.append("faculty", faculty);
      formData.append("program", program);
      formData.append("year_or_sem", semester);
      ...
      alert(`Signup successful! Welcome, ${data.full_name}`);

      // Reset form
      setName(""); setEmail(""); setPassword("");
      setTuNumber(""); setFaculty(""); setProgram(""); setSemester("");
      setIdCard(null); setPreview(null); setErrors({});
    } catch (error) {
        ...
        >
          ...
          <form onSubmit={handleSignup} className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
            ...
            <div className="flex flex-col">
              ...
              {errors.tuNumber && <span className="text-xs text-red-600 mt-1">{errors.tuNumber}</span>}
            </div>
            ...
            <div className="flex flex-col">
              ...
              {errors.program && <span className="text-xs text-red-600 mt-1">{errors.program}</span>}
            </div>
            ...
            <div className="flex flex-col col-span-2">
              ...
              {errors.semester && <span className="text-xs text-red-600 mt-1">{errors.semester}</span>}
            </div>            {/* ID Card Upload */}
            <div className="flex flex-col col-span-2">
              <div className="flex items-center border-b-2 border-foreground/50 focus-within:border-foreground rounded-lg">
