  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-void relative">
      <div className="text-center relative z-10">
        ...
        <Link href="/login" className="inline-flex px-5 py-2.5 bg-gold text-void rounded-[var(--radius-md)] font-[var(--font-display)] font-bold text-[11px] uppercase tracking-wider hover:bg-gold-bright transition-all">
          Back to Sign In
        </Link>
      </div>
    </div>
