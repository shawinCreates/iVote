...
class RegistrationStage(str, enum.Enum):
    STAGE1 = "stage1"   # credentials only
    STAGE2 = "stage2"   # academic details
    STAGE3 = "stage3"   # id card uploaded
    COMPLETE = "complete"  # photo captured → full registration done
...
class User(Base):
    ...
    registration_stage = Column(SAEnum(RegistrationStage), nullable=False, default=RegistrationStage.COMPLETE)
